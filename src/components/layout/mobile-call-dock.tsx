    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-x-0 bottom-0 z-40 border-t border-white/45 bg-ink-950/90 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 backdrop-blur-xl sm:hidden"
        >
          <div className="flex items-center gap-2.5">
            ...
            <a
              ...
              className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-white/15 bg-white/[0.16] text-white"
            >
