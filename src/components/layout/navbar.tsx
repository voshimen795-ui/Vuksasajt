  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "border-b border-white/45 bg-ink-950/95 backdrop-blur-xl" : "border-b border-transparent",
      )}
    >
      <div className="container flex h-[72px] items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-expanded={open}
            className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/45 bg-white/[0.18] text-white lg:hidden"
          >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="border-t border-white/45 bg-ink-950/95 backdrop-blur-xl lg:hidden"
          >
